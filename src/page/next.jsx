  ...
  return (
    <div className="border-2 border-green-500 shadow-[0_4px_10px_rgba(34,197,94,0.5)] 
      ...
      <div className="flex justify-between">
        ...
        <p className="font-serif text-sm sm:text-base">Step 2/2</p>
      </div>
      ...
      <p className="font-serif text-center mt-2 text-sm sm:text-base">
        You can Download or Check for a copy
      </p>
      ...
      <div className="flex justify-center mt-6">
        <a href="/next" className="bg-green-600 text-white px-4 py-2 rounded-md text-sm sm:text-base">
          Next
        </a>
      </div>
    </div>
